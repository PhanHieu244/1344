...
using UnityEngine.Profiling;
	...
	public class ObjectSlice : BzSliceableCharacterBase, IBzSliceableNoRepeat
	{
...
#pragma warning restore 0649
		...
		protected override void OnSliceFinished(BzSliceTryResult result)
		{
			...
			var resultNeg = result.outObjectNeg.GetComponent<ObjectSlice>();
			var resultPos = result.outObjectPos.GetComponent<ObjectSlice>();
